...
def pending_row(empresa, doc, monto, estado, dias):
    ...
    return ft.Container(
        padding=ft.padding(vertical=10),
                ...
                ft.Column(
                    ...
                    controls=[
                        ft.Container(
                            bgcolor=estado_bg,
                            border_radius=12,
                            padding=ft.padding(horizontal=10, vertical=3),
...
with open('sii_conect/src/components/ui.py', 'w', encoding='utf-8') as f:
    f.write(ui_code)
print('ui.py written successfully')
'